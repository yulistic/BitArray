...
BIT_ARRAY *bit_array_init_shm(BIT_ARRAY *bitarr, bit_index_t nbits,
			      word_t *words_p);
...
bit_index_t bit_array_get_bits(const BIT_ARRAY *bitarr, bit_index_t start,
			       bit_index_t end, bit_index_t *dst);
...
void bit_array_set_region(BIT_ARRAY *bitarr, bit_index_t start,
			  bit_index_t len);

// Clear all the bits in a region
void bit_array_clear_region(BIT_ARRAY *bitarr, bit_index_t start,
			    bit_index_t len);

// Toggle all the bits in a region
void bit_array_toggle_region(BIT_ARRAY *bitarr, bit_index_t start,
			     bit_index_t len);
...
void bit_array_set_wordn(BIT_ARRAY *bitarr, bit_index_t start, uint64_t word,
			 int n);
...
char bit_array_find_first_clear_bit(const BIT_ARRAY *bitarr,
				    bit_index_t *result);
...
// If no bit is zero result is not changed
char bit_array_find_last_clear_bit(const BIT_ARRAY *bitarr,
				   bit_index_t *result);
...
void bit_array_from_substr(BIT_ARRAY *bitarr, bit_index_t offset,
			   const char *str, size_t len, const char *on,
			   const char *off, char left_to_right);
...
void bit_array_to_substr(const BIT_ARRAY *bitarr, bit_index_t start,
			 bit_index_t length, char *str, char on, char off,
			 char left_to_right);
...
void bit_array_print_substr(const BIT_ARRAY *bitarr, bit_index_t start,
			    bit_index_t length, FILE *fout, char on, char off,
			    char left_to_right);
...
size_t bit_array_to_hex(const BIT_ARRAY *bitarr, bit_index_t start,
			bit_index_t length, char *str, char uppercase);

// Print bit array as hex
size_t bit_array_print_hex(const BIT_ARRAY *bitarr, bit_index_t start,
			   bit_index_t length, FILE *fout, char uppercase);
...
void bit_array_copy(BIT_ARRAY *dst, bit_index_t dstindx, const BIT_ARRAY *src,
		    bit_index_t srcindx, bit_index_t length);
...
//
void bit_array_and(BIT_ARRAY *dest, const BIT_ARRAY *src1,
		   const BIT_ARRAY *src2);
void bit_array_or(BIT_ARRAY *dest, const BIT_ARRAY *src1,
		  const BIT_ARRAY *src2);
void bit_array_xor(BIT_ARRAY *dest, const BIT_ARRAY *src1,
		   const BIT_ARRAY *src2);
...
int bit_array_cmp_big_endian(const BIT_ARRAY *bitarr1,
			     const BIT_ARRAY *bitarr2);

// compare bitarr with (bitarr2 << pos)
int bit_array_cmp_words(const BIT_ARRAY *bitarr, bit_index_t pos,
			const BIT_ARRAY *bitarr2);
...
void bit_array_shift_right(BIT_ARRAY *bitarr, bit_index_t shift_dist,
			   char fill);
...
void bit_array_reverse_region(BIT_ARRAY *bitarr, bit_index_t start,
			      bit_index_t len);
...
void bit_array_add_words(BIT_ARRAY *bitarr, bit_index_t pos,
			 const BIT_ARRAY *add);
...
void bit_array_add(BIT_ARRAY *dst, const BIT_ARRAY *src1,
		   const BIT_ARRAY *src2);
...
void bit_array_subtract(BIT_ARRAY *dst, const BIT_ARRAY *src1,
			const BIT_ARRAY *src2);
